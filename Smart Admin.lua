...
SmartAdmin.Settings = {
	...
	["TabletMovement"] = "Clientside", -- Clientside or Serverside(Clientside looks better)
	...
	--["TabletMeshScale"] = Vector3.new(0.03,0.03,0.03), -- Don't bother with it.
	["Font"] = "Legacy", -- Dat font doe.
	["FontSize"] = "Size12", -- Dat font size doe.
}
